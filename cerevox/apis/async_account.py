...
class AsyncAccount(AsyncClient):
    """
    ...
    >>> client = AsyncAccount(api_key="your_pat_token")
    ...
    >>> try:
    ...     user = await client.get_user_by_id("user123")
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """
        Initialize the AsyncAccounts client and authenticate with Cerevox.
        ...
        **kwargs : dict
            Additional aiohttp ClientSession arguments,
