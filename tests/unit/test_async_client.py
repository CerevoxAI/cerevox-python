"""
Test suite for cerevox.core.async_client

Comprehensive tests to achieve 100% code coverage for the AsyncClient class,
...
from cerevox.core import AsyncClient, LexaError, TokenResponse


class TestAsyncClientAuthUrl:
    """Test class for AsyncClient auth_url functionality"""
    ...
    def test_auth_url_defaults_to_data_url_when_none(
        ...
        client = AsyncClient(api_key=valid_api_key, data_url=valid_data_url)
    ...
    def test_auth_url_defaults_to_data_url_when_empty_string(
        ...
        client = AsyncClient(
            api_key=valid_api_key, data_url=valid_data_url, auth_url=""
        )
    ...
    def test_auth_url_validation_non_string_type(self, valid_api_key, valid_data_url):
        ...
        with pytest.raises(ValueError, match="auth_url must be a non-empty string"):
            AsyncClient(api_key=valid_api_key, data_url=valid_data_url, auth_url=123)
    ...
    def test_auth_url_different_from_data_url_independence(self, valid_api_key):
        ...
        client = AsyncClient(
            api_key=valid_api_key, data_url=data_url, auth_url=auth_url
        )
    ...
    def test_auth_url_with_environment_api_key(self, valid_data_url):
        ...
        client = AsyncClient(data_url=valid_data_url, auth_url=custom_auth_url)
...
class TestAsyncClientInitialization:
    """Test class for AsyncClient initialization functionality"""
    ...
    @pytest.mark.asyncio
    async def test_refresh_token_no_api_key_raises_error(self, valid_data_url):
    ...
    @pytest.mark.asyncio
    async def test_refresh_token_empty_api_key_raises_error(self, valid_data_url):
